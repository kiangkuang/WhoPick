      ...
      states: {
        ...
        addQuestion: {
          "*": function (client, msg) {
            ...
            Repo.addQuestion(client.userId, client.name, msg).then((result) => {
              msg = msg
                .replace(/&/g, "&amp;")
                .replace(/</g, "&lt;")
                .replace(/>/g, "&gt;")
        ...
        addOption: {
          _onEnter(client) {
            bot.sendMessage(client.userId, `Send me an answer option.`, {
              parse_mode: "HTML",
            });
          },
          "*": function (client, msg) {
        ...
        polls: {
          _onEnter: function (client) {
            Repo.getQuestions({
              ...
              const opts = {
                parse_mode: "HTML",
                reply_markup: new Poll(polls).getPollsInlineKeyboard(),
              };
              bot
                .sendMessage(client.userId, "Here are your polls:", opts)
                .then(() => {
        ...
        showPoll: {
          _onEnter: function (client) {
            Repo.getQuestion(client.questionId).then((question) => {
              ...
              bot.sendMessage(client.userId, poll.toString(), opts).then(() => {
                this.transition(client, "none");
              });
            });
          },
